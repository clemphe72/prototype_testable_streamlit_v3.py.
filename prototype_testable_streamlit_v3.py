...
st.set_page_config(page_title="Comparateur IA - ChatGPT-4o vs Optimisation", layout="wide")
...
# Titre
st.title("🔍 Comparateur IA : ChatGPT-4o vs Optimisation")
...
# Fonction pour obtenir une réponse de ChatGPT-4o via l'API OpenAI
...
if query and api_key:
    ...
    with col2:
        st.markdown("### ⚡ Notre Optimisation")
    ...
    data = {
        ...
        "Notre Optimisation": [time_project, "🚀 Optimisée", "🌟 Excellente", "🔋 Efficace", "🟢 90/100"]
    }
